...
function (_HTMLElement) {
  ...
  _createClass(Component, [{
    ...
    value: function _mergeNodes(newChild, existChild, parentNode) {
      ...
      if (!existChild && newChild) return parentNode.appendChild(newChild); // Exist child should be replaced by nothing. Remove exist child
    ...
    value: function setState(newState) {
      if (typeof newState === 'function') {
        this.state = newState(_objectSpread({}, this.state));
      } else {
        this.state = newState;
      }
