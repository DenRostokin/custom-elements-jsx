...
function (_HTMLElement) {
  ...
  function Component() {
    ...
    _this._componentShadowRoot = _this.attachShadow({
      mode: 'open'
    });
    _this.state = {};

    _this.update = function () {
      if (_this._componentShadowRoot.children.length) {
        _this._componentShadowRoot.replaceChild(_this.render(), _this._componentShadowRoot.children[0]);
  ...
  _createClass(Component, [{
    ...
    value: function _setChildren() {
      this.props.children = this.childNodes.length ? Array.prototype.slice.call(this.childNodes) : null;
    }
  }, {
