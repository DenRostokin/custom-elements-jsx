...
function (_HTMLElement) {
  ...
  _createClass(Component, [{
    ...
    value: function _cloneEventHandlers() {
      var newChild = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var existChild = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var regexp = /^(on[a-z]+)$/i;
    ...
    value: function _mergeNodes(newChild, existChild, parentNode) {
      if ((0, _utils.areSameTagNames)(newChild, existChild)) {
        // add new attributes
    ...
    value: function _mergeCollections(newContent, existChildren, parentNode) {
      if (newContent.length) {
        var i, j;

        for (i = 0, j = 0; i < newContent.length; ++i, ++j) {
          var newChild = newContent[i];
          var newChildPosition = typeof newChild.__DOMPosition__ === 'number' ? newChild.__DOMPosition__ : 0;
          var existChild = existChildren[j];
          var existChildPosition = existChild && typeof existChild.__DOMPosition__ === 'number' ? existChild.__DOMPosition__ : 0;
    ...
    value: function _updateContent(newContent) {
      ...
      var newCollection = typeof newContent[Symbol.iterator] === 'function' ? _toConsumableArray(newContent) : [newContent];

      this._mergeCollections(newCollection, _toConsumableArray(existChildren), parentNode);
    }
  }, {
    ...
    value: function setState(newState) {
      if (typeof newState === 'function') {
        var computedState = newState(_objectSpread({}, this.state), _objectSpread({}, this.props));
        this.state = _objectSpread({}, this.state, computedState);
      } else {
