...
exports.setAttribute = exports.objectToStyleString = exports.isCustomElement = exports.isSVG = exports.areSameNodes = void 0;
...
var areSameNodes = function areSameNodes(el1, el2) {
  return el1 && el2 && el1.tagName && el2.tagName && el1.tagName === el2.tagName;
};
